...
export const myProducts: productInterface[] = [
  ...
  },
  {
    ...
    description:
      'The CyberPowerPC Gamer Master is built for gamers who want both power and performance. Featuring an AMD Ryzen 7 8700F processor and 16GB of DDR4 RAM, it handles modern games and multitasking with ease. The AMD Radeon RX 7600 graphics card delivers crisp, immersive visuals for an outstanding gaming experience. With its sleek design and reliable hardware, the Gamer Master is an excellent choice for anyone looking to upgrade their gaming setup.',
    RAM: '16GB DDR4',
